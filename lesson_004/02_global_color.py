...
# TODO: меню мы можем генерировать в цикле, если colors_list помимо самого цвета будет содержать еще и его название.
#  Тогда если кто-то будет добавлять/удалять цвет в список, он будет модифицировать только список цветов, и править
#  меню ему не нужно (он может не помнить об этом).
...
# TODO: условие лучше изменить, сранивая с размером списка. Ввели число >= длины списка? вводите заново!
